---
name: do-implement
description: 'Pi direct implementation: implement an approved `plan.md` in one fresh interactive TUI path. It does not decompose for Herdr, write route files, or start `/tui-control`.'
argument-hint: <approved-plan.md>
---

# /do-implement

Pi direct implementation front door for an approved plan.

Use the shared implementation contract below with command name `do-implement`.
