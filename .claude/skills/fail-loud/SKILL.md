---
name: fail-loud
description: Cross-language rule against silent failure. Apply when writing or reviewing any error handling — Python try/except, TypeScript try/catch, Go err checks.
---
