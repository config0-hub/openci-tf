---
name: upagent-cleanup
description: Dry-run or explicitly apply terminal-only UpAgent history pruning while retaining auditable, idempotent tombstones and caller-owned artifacts.
---
