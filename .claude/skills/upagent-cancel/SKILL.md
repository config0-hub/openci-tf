---
name: upagent-cancel
description: Authenticate and cancel one active UpAgent request at any lifecycle point using its existing requester control token, without a timeout nonce.
---
