---
name: cc-implement
description: 'Claude Code direct implementation: implement an approved `plan.md` in one fresh interactive TUI path. It does not decompose for Herdr, write route files, or start `/tui-control`.'
argument-hint: <approved-plan.md>
---

# /cc-implement

Claude Code direct implementation front door for an approved plan.

Use the shared implementation contract below with command name `cc-implement`.
