...
def test_prepare_drift_requires_only_runtime_upstream_and_omits_shared_tool_secrets(monkeypatch, tmp_path):
    ...
    assert "CACHE_GET_URL_TOFU_1_10_6" in secrets
